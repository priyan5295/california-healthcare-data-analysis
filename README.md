...
* Analysis of **3,294 licensed healthcare facilities** across California from 2022 to January 2026 using Python
* Covers **data loading, cleaning, statistical analysis, 12 visualizations, and predictive trend analysis**
* Focus areas:
...
* Enables **trend analysis and decision-making for healthcare planning**
...
* 📊 **Stage 3: Visualization** — Built 12 charts (Univariate, Bivariate, Multivariate)
...
* Maintain central dataset with location, license type, beds, county, and service level
* Understand how facilities are distributed across California by county, city, and facility level
* Evaluate the availability of Emergency (ER) services and total bed capacity
* Track facility status updates and year-wise licensing trends (2022–2026)
...
* 📧 Email: [sathicse5@gmail.com](mailto:sathicse5@gmail.com)
* 🔗 LinkedIn: [https://www.linkedin.com/in/sathiya-priyan-da/](https://www.linkedin.com/in/sathiya-priyan-da/)
* 🐙 GitHub: [https://github.com/priyan5295](https://github.com/priyan5295)
